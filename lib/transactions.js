...
exports.createGeneration = function(rpcData, blockReward, feeReward, recipients, poolAddress){
    ...
    //strProofOfGameplayAddress 10% of coinbase
    ...
    //strJackpotAddress 1% of coinbase
    var strJackpotAddress 		= rpcData.JackpotAddress;
    var strJackpotAddressHash 	= bitcoin.address.fromBase58Check(strJackpotAddress).hash;
    //strDevFundAddress 5% of coinbase
    ...
    var strDevFundAddressHash 	= bitcoin.address.fromBase58Check(strDevFundAddress).hash;
      ...
      tx.addOutput(
        scriptCompile(strJackpotAddressHash),
        Math.floor(rpcData.JackpotValue)
      );
      tx.addOutput(
